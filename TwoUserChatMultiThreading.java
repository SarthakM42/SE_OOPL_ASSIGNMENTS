public class TwoUserChatMultiThreading {
    public static void main(String[] args) throws Exception {
        ChatUser u1 = new ChatUser("Anuja");
        ChatUser u2 = new ChatUser("Madhura");
        ...
        System.out.println("Anuja alive ?"+u1.isAlive());

        Thread.sleep(1000);
        u2.pauseChat();
        System.out.println("Madhura paused...");

        Thread.sleep(1000);
        u2.resumeChat();
        System.out.println("Madhura Repushed ...");

        Thread.sleep(1000);
        u1.stopChat();
        System.out.println("Anuja Stoped...");

        u1.join();
        u2.join();

        System.out.println("Anuja Alive After join ?"+u1.isAlive());
